...
function togglePlay() {
  if (player.paused) {
    playpauseBtn.className = "buffering circle animated play-pause-btn rotar";
    playPause.className = "fa fa-pause icono";
    // playPause.attributes.d.value = "M0 0h6v24H0zM12 0h6v24h-6z";
    player.play();
  } else {
    playpauseBtn.className = "buffering circle animated play-pause-btn";
    playPause.className = "fa fa-volume-up icono";
    // playPause.attributes.d.value = "M18 12L0 24V0";
    player.pause();
  }
}
